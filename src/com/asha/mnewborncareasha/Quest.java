...
public class Quest extends Activity {
	...
	String grpinfo[]={"शिशु की जांच","माँ की जांच","जीवाणु संक्रमण जांच","दस्त रोग की जांच","स्तनपान सम्बंधित जांच"};
	String vst_seq[]={"1. पहली जाँच","2. दूसरी जाँच","3. तीसरी जाँच","4. चौथी जाँच","5. पांचवी जाँच","6. छठी जाँच","7. सातवी जाँच"};
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  face=Typeface.createFromAsset(getAssets(),getString(R.string.hindi_font));
        ...
        else btnQuest.setText("अतिरिक्त जाँच");
		...
		btnBack.setOnClickListener(new OnClickListener() {
			...
			{	
				...
				for(int i=1;i<pans_arr.length;i++)
				{
					...
					if (qtype==0) { 
						String st=" ";
						if (pans_arr[i].contentEquals("1")) st="हाँ";
...
"dtm"  INTEGER
			...
			{	
			try {
				    Cursor server_id_data =mydb.getServer_id(pid);
				    int server_id = 0;
				    if(server_id_data.moveToFirst())
				    {
				    	server_id=server_id_data.getInt(0);
					...
					{
						mydb.sendGPRS(AppVariable.API_INDEX(mContext)+"pncv", payload.toString(),1); 
					}
				} catch (Exception e) {
