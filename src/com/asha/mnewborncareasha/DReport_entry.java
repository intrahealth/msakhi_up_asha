...
public class DReport_entry extends Activity {
	...
	Calendar gcal,mc;
	TextView tvMname;
	String dstr[]={"शिशु","माँ","दोनों (शिशु और माँ)"};
	@Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        dtp.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
...
*/
    ...
    void openPreviewDialog(){
     ...
     llContent.removeAllViews();
    	...
    	tvH.setText("माँ का नाम : "+tvMname.getText());
    	tvH.setTextSize(18);
    	tvH.setTextColor(Color.BLUE);
    	TextView tvEdd=new TextView(ctx);
    	tvEdd.setText(String.format("मृत्यु की तारीख : %d-%s-%d",dtp.getDayOfMonth(),DBAdapter.hmstr[dtp.getMonth()],dtp.getYear()));
    	tvEdd.setTextSize(18);
    	tvEdd.setTextColor(Color.BLUE);  
    	TextView tvDth=new TextView(ctx);
    	tvDth.setText(String.format("मृत्यु: "+dstr[(int)spnDstat.getSelectedItemId()]));
    	tvDth.setTextSize(18);
    	tvDth.setTextColor(Color.BLUE);  
    	llContent.addView(tvH);
    	llContent.addView(tvEdd);
    	llContent.addView(tvDth);
     customDialog.setPositiveButton("हाँ", new DialogInterface.OnClickListener(){
			...
			dstat=(int)spnDstat.getSelectedItemId();
				...
				String phoneNumber=getString(R.string.smsno);
					...
					try {
				        ...
				        Toast.makeText(getApplicationContext(),"मृत्यु की सुचना सेव हो गयी", Toast.LENGTH_SHORT).show();
				        /*
